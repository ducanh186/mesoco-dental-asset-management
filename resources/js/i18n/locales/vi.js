...
export default {
    ...
    nav: {
        dashboard: 'Tổng quan',
        profile: 'Hồ sơ',
        qrScan: 'Quét QR thiết bị',
        bfdCatalog: 'Quản lý danh mục và hồ sơ',
        ...
        repair: 'Sửa chữa',
        preventiveMaintenance: 'Bảo trì định kì',
        repairLogs: 'Nhật ký sửa chữa',
        equipment: 'Thiết bị',
        shifts: 'Ca làm',
        checkin: 'Ghi nhận ca',
        ...
        lifecycleAnalysisReport: 'Phân tích vòng đời',
        settings: 'Cài đặt',
        users: 'Người dùng',
        ...
        recordsManagement: 'Hồ sơ nghiệp vụ',
        assetRecords: 'Hồ sơ thiết bị',
        handoverRecords: 'Hồ sơ bàn giao',
        returnRecords: 'Hồ sơ thu hồi',
        inventoryRecords: 'Hồ sơ kiểm kê',
        maintenanceRecords: 'Hồ sơ bảo trì',
        logout: 'Đăng xuất',
        collapse: 'Thu gọn',
        expand: 'Mở rộng',
    },
    ...
    dashboard: {
        ...
        welcomeSubtitleAdmin: 'Tổng quan hệ thống quản lý thiết bị Mesoco.',
    ...
    assets: {
        title: 'Thiết bị',
        subtitle: 'Quản lý thiết bị theo vị trí và nhân viên chịu trách nhiệm',
        ...
        checkIn: 'Ghi nhận',
        checkOut: 'Kết thúc ghi nhận',
        checkinStatus: 'Trạng thái ghi nhận',
        checkedIn: 'Đã ghi nhận',
        notCheckedIn: 'Chưa ghi nhận',
        checkinSuccess: 'Ghi nhận thành công',
        checkoutSuccess: 'Kết thúc ghi nhận thành công',
        checkedInAt: 'Đã ghi nhận lúc',
        notCheckedInYet: 'Chưa ghi nhận hôm nay',
    ...
    requests: {
        ...
        fromShift: 'Từ ca',
        toShift: 'Đến ca',
        handlingPurpose: 'Mục đích xử lý',
    ...
    requestType: {
        ...
        retiredCirculation: 'Luồng cũ đã ngừng dùng',
    ...
    confirm: {
        ...
        regenerateIdentifier: 'Tạo lại định danh',
    ...
    printableLabel: {
        ...
        handoverNote: 'Thiết bị gắn với nhân viên chịu trách nhiệm',
        qrPortalHint: 'Quét mã để mở portal thiết bị trên điện thoại hoặc trình duyệt',
    ...
    locationsPage: {
        title: 'Vị trí',
        subtitle: 'Quản lý mã vị trí, tên vị trí và mô tả nơi đặt thiết bị',
