...
- `Location` trả lời câu hỏi: thiết bị đang ở đâu.
...
- `Disposal` ghi nhận thiết bị bị thu hủy; sau bước này asset không còn location active và không còn responsible employee active.
